...
insert into "BAGS" ("ID", "VOLUME", "TITLE") values (1, 20.0, 'bag1');
insert into "BAGS" ("ID", "VOLUME", "TITLE") values (2, 30.0, 'bag2');
insert into "BAGS" ("ID", "VOLUME", "TITLE") values (3, 100.0, 'bag3');
